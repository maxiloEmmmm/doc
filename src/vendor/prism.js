/* PrismJS 1.23.0
https://prismjs.com/download.html#themes=prism&languages=markup+css+clike+javascript&plugins=line-highlight+line-numbers+file-highlight */
...
(function () {
	...
	var STATUS_ATTR = 'data-src-status-c';
	var STATUS_LOADING = 'loading';
	var STATUS_LOADED = 'loaded';
	var STATUS_FAILED = 'failed';

	var SELECTOR = 'pre[data-src-c]:not([' + STATUS_ATTR + '="' + STATUS_LOADED + '"])'
	...
	Prism.hooks.add('before-sanity-check', function (env) {
		...
		if (pre.matches(SELECTOR)) {
			...
			var src = pre.getAttribute('data-src-c');
            var split = pre.getAttribute('data-split-c');
	...
	Prism.plugins.fileHighlightC = {
		 ...
		 */
		highlightC: function highlightC(container) {
